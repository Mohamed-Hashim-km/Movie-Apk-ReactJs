        ...
        <>
          <div className="overflow-hidden ">
            <div className="pb-[30px] " id="home">
              ...
              <div className={isFavoriteShowMore ? "flex overflow-x-scroll scroll m-2" : "w-full"}>
                <div className={isFavoriteShowMore ? "flex  gap-3 mb-3" : "flex-wrap flex w-full gap-2 mt-2 ml-8 "}>
                  <FavoriteMovies />
                </div>
              </div>
              ...
              <div className={isTrendingShowMore ? "flex overflow-x-scroll scroll m-2 flex-row" : "w-full"}>
                <div className={isTrendingShowMore ? "flex  gap-3 mb-3" : "flex-wrap flex w-full gap-2 mt-2 ml-8 "}>
                  <TrendingMovies />
                </div>
              </div>
              ...
              <div className={isRatedShowMore ? "flex overflow-x-scroll scroll m-2" : "w-full"}>
                <div className={isRatedShowMore ? "flex  gap-3 mb-3" : "flex-wrap flex w-full gap-2 mt-2 ml-8 "}>
                  <RatedMovie />
                </div>
              </div>
            </div>
