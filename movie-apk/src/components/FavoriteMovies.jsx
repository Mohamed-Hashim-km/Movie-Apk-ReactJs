 ...
 const {value}=useParams()
  ...
  return (
    ...
    <div className="min-h-[100vh]">
     {isLoading?<><Loader /></> :<>
   {value=="true"?( <><div className="flex flex-wrap gap-2 mt-2 ml-8">
      {movies.map((item,index) => {
        return (
          <div key={index}>
            <Card style={{ width: "18rem", height: "30%" }} className="bg-white hover:transition-all hover:duration-500 hover:transform hover:scale-75 hover:z-50 hover:filter hover:ease-in duration-500" >
